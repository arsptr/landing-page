                    ...
                    >
                        ...
                        <Offcanvas.Body>
                            <Nav className="justify-content flex-grow-1 pe-3">
                                <NavDropdown active title="Features">
                                    <NavDropdown.Item href="#features/ToDo-List">
                                    ...
                                    <NavDropdown.Item href="#features/reminders">
                                    ...
                                    <NavDropdown.Item href="#features/planning">
                                ...
                                <NavDropdown title="Company" id="basic-nav-dropdown">
                                    <NavDropdown.Item href="#company/history">History</NavDropdown.Item>
                                    <NavDropdown.Item href="#company/our-team">Our Team</NavDropdown.Item>
                                    <NavDropdown.Item href="#company/blog">Blog</NavDropdown.Item>
                                </NavDropdown>
